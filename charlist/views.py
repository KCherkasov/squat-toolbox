...
player_fact_words = {
    ...
    'SK_PSY': u'Немногие способны подметить проявления нематреиального (пси-сенс):',
    ...
    'TL_WTFN': u'Благородное призвание охотника за колдунам нередко недооценивают, совершенно напрасно:',
    ...
    'TL_DSVC': u'Отнюдь не каждому дано поставить собеседника на место парой слов,'
               u'еще меньше тех, у кого хватит для этого стали в голоси:',
