...
SKILL_TAGS = [SK_ATHLETICS, SK_DEXTERITY, SK_DISCIPLINE, SK_FORTITUDE, SK_INTUITION, SK_LINGUISTICS, SK_LOGIC, SK_LORE,
              SK_MEDICAE,   SK_MELEE,     SK_NAVIGATION, SK_PILOTING,  SK_PRESENCE,  SK_PSYCHIC,     SK_RANGED,
              SK_RAPPORT,   SK_REFLEXES,  SK_STEALTH,    SK_TECH]
...
SP_HUMAN = 'SP_HMN'
SP_BRAWLING = 'SP_BRWL'
SP_ONE_HANDED = 'SP_OHND'
SP_TWO_HANDED = 'SP_THND'
SP_SURFACE = 'SP_SRF'
SP_TRACKING = 'SP_TRK'
SP_NAV_VOID = 'SP_VOID'
SP_NAV_WARP = 'SP_WRP'
