...
urlpatterns = [
    ...
    path(r'dev/create-character/init/', charviews.create_character_init, name='create-character-init'),
    path(r'dev/create-character/hw-choice/', charviews.create_character_hw_choice, name='create-character-hw'),
    path(r'dev/create-character/characteristics/', charviews.create_character_stat_distribution,
         name='create-character-stats'),
    path(r'dev/create-character/bg-choice/', charviews.create_character_bg_choice, name='create-character-bg'),
    path(r'dev/create-character/role-choice/', charviews.create_character_role_choice, name='create-character-role'),
    path(r'dev/create-character/choices/', charviews.create_character_choices, name='create-character-choice'),
    path(r'dev/create-character/double-apts/', charviews.create_character_double_apts,
